...
class double_buffered_scratchpad:
    ...
    def set_params(self,
                   ...
                   ifmap_backing_buf_bw=1, filter_backing_buf_bw=1, ofmap_backing_buf_bw=1, array_row=16):
        ...
        if self.estimate_bandwidth_mode:
            ...
            if self.double_buffer  :
                ...
                self.ifmap_L2_buf.set_params(backing_buf_obj=self.ifmap_CSC_buf,
    ...
    def set_read_buf_prefetch_matrices(self,
        ...
        if self.double_buffer :
            ...
            self.ifmap_CSC_buf.set_fetch_matrix(ifmap_prefetch_mat)
    ...
    def service_memory_requests(self, ifmap_demand_mat, filter_demand_mat, ofmap_demand_mat):
        ...
        if self.estimate_bandwidth_mode:
            ...
            if self.double_buffer:
                ...
                self.ifmap_CSC_buf.complete_all_prefetches()
    ...
    def get_ifmap_dram_details(self):
        ...
        if self.double_buffer :
            self.ifmap_dram_reads = self.ifmap_CSC_buf.get_num_accesses()
            self.ifmap_dram_start_cycle, self.ifmap_dram_stop_cycle \
                = self.ifmap_CSC_buf.get_external_access_start_stop_cycles()
        else:
    ...
    def get_ifmap_dram_trace_matrix(self):
        ...
        if self.double_buffer:
            ...
            return self.ifmap_CSC_buf.get_trace_matrix()
        else:
    ...
    def get_dram_trace_matrices(self):
        ...
        if self.double_buffer:
            ...
            dram_ifmap_trace = self.ifmap_CSC_buf.get_trace_matrix()
    ...
    def print_ifmap_dram_trace(self, filename):
        ...
        if self.double_buffer:
            self.ifmap_CSC_buf.print_trace(filename)
        else :
